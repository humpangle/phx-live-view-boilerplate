defmodule MeApp.TimelineTest do
  use MeApp.DataCase
  ...
  describe "posts" do
    ...
    @invalid_attrs %{body: nil, likes_count: nil, photo_urls: nil, reposts_count: nil, username: nil}
    ...
    test "create_post/1 with valid data creates a post" do
      valid_attrs = %{body: "some body", likes_count: 42, photo_urls: [], reposts_count: 42, username: "some username"}
