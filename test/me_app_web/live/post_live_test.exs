defmodule MeAppWeb.PostLiveTest do
  use MeAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import MeApp.TimelineFixtures

  @create_attrs %{body: "some body", likes_count: 42, photo_urls: [], reposts_count: 42, username: "some username"}
  @update_attrs %{body: "some updated body", likes_count: 43, photo_urls: [], reposts_count: 43, username: "some updated username"}
  @invalid_attrs %{body: nil, likes_count: nil, photo_urls: [], reposts_count: nil, username: nil}
